...
#ifndef TINY_DICE_MAX_SUBJECT_SIZE
#define TINY_DICE_MAX_SUBJECT_SIZE (CBOR_SIZE_1 - 1)
#endif /* TINY_DICE_MAX_SUBJECT_SIZE */

#ifndef TINY_DICE_MAX_CERT_SIZE
#define TINY_DICE_MAX_CERT_SIZE \
  (CBOR_UNSIGNED_SIZE((size_t)TINY_DICE_LABEL_MAX) \
   + (CBOR_UNSIGNED_SIZE(TINY_DICE_LABEL_MAX - 1) * TINY_DICE_LABEL_MAX) \
   + CBOR_BYTE_STRING_SIZE(TINY_DICE_MAX_SUBJECT_SIZE) \
   + CBOR_BYTE_STRING_SIZE(TINY_DICE_ISSUER_ID_SIZE) \
   + CBOR_UNSIGNED_SIZE(TINY_DICE_CURVE_MAX - 1) \
...
/**
 * Initializes a TinyDICE certificate chain with default values.
 *
 * @param cert_chain The TinyDICE certificate chain.
 * @param length     Length of @c cert_chain.
 */
void tiny_dice_init_cert_chain(tiny_dice_cert_chain_t *cert_chain,
                               size_t length);
...
void tiny_dice_write_cert_chain(cbor_writer_state_t *state,
                                const tiny_dice_cert_chain_t *cert_chain);
